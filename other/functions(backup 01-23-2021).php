...
if(isset($_POST['btn_export'])){ 
    ...
    if(empty($db_fname) || empty($db_mname) || empty($db_lname) || empty($db_m_fname) || empty($db_m_mname) || empty($db_m_lname) || empty($db_birthdate) || empty($db_title) || empty($db_marital_status) || empty($db_birth_place) || empty($db_present_street) || 
